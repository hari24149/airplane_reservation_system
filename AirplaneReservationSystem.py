...
def display_welcome():
    ...
    print(f"{bcolors.BOLD}{bcolors.HEADER}{bcolors.UNDERLINE}, "
          f"https://github.com/hari24149,We would like to take some information:{bcolors.ENDC}{bcolors.ENDC}{bcolors.ENDC}")
...
def accept_users_seat(): 
    ...
    while True:
        if current_user_number <= terminator:
            name[current_user_number] = input("Your Name please: ") 
            name[current_user_number].strip() 
            name[current_user_number] = name[current_user_number] + " " 
...
def display_boarding_pass():
    ...
    for i in range(0, number_of_seats_booked):
        ...
        print("https://github.com/hari24149")
